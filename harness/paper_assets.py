...
def main():
    ...
    # Drop the claude-haiku n=8 spot-check: it is not a registered arm and inviting
    # selection questions for no information gain (reviewer feedback).
    alldf = alldf[~alldf["model"].str.contains("haiku")].reset_index(drop=True)
